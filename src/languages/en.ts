...
const English: Language = {
  ...
  satteliteView: 'Satellite View',
  yourlocation: 'Your Location',
  picklocation: 'Pickup Location',
  timeline: 'timeline',
  okmessage: 'Press more icon on top right of the screen to access the menu!',
  ok: 'Ok',
  pickuprequest: 'Pickup Request',
  completereq: 'Complete Request',
  cancelReq: 'Cancel Request',
  deleteReq: 'Delete Request',
  mess10: 'No action available for this order!',
  mess11: 'Could not cancel delivery of the order!',
  mess12: 'There was some issue while trying to pick the request!',
  orderplaced: 'Order Placed',
  adminapprove: 'Approved by Admin',
